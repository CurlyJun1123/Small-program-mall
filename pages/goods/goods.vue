<template>
	<view>
		...
		<view class="info-box goods-info">
			<view class="price">
				<text class="current-text">￥</text>
				<text class="current-price">{{ goodsData.currentPrice }}</text>
				<text class="original-text">价格￥</text>
				<text class="original-price">{{ goodsData.originalPrice }}</text>
			</view>
			<!-- <view class="original-price">原价￥{{ goodsData.originalPrice }}</view> -->
		...
		<!-- 占位 -->
		<view v-if="showHeader" class="place-bottom"></view>
	</view>
</template>
